...
TableCompiler.prototype.index = function(columns, indexName) {
  indexName = indexName
    ? this.formatter.wrap(indexName)
    : this._indexCommand('index', this.tableNameRaw, columns);
  columns = this.formatter.columnize(columns);
...
TableCompiler.prototype.primary = TableCompiler.prototype.foreign = function() {
  if (this.method !== 'create' && this.method !== 'createIfNot') {
    this.client.logger.warn('SQLite3 Foreign & Primary keys may only be added on create');
  }
};

TableCompiler.prototype.primaryKeys = function() {
...
TableCompiler.prototype.foreignKeys = function() {
  let sql = '';
...
TableCompiler.prototype.createTableBlock = function() {
